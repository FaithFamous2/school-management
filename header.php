...
<html class="no-js">
    <head>
        <title>FAMOUS LMS</title>
		<meta name="description" content="Learning Management System">
		<meta name="keywords" content="FAMOUS LMS,FAMOUSLMS,FAMOUS,LMS,FSAMOUSLMS.COM">
		<meta name="author" content="FAITH OLOWOOKERE">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
				<!-- <link href="admin/images/favicon.ico" rel="icon" type="image"> -->
				<link href="admin/images/logo1.png" rel="icon" type="image">
				...
				<link href="admin/bootstrap/css/W3.css" rel="stylesheet" media="screen"/>
				<!-- data table css -->
