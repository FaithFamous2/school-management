			...
			<!-- <label>Country</label>
			<select class="input-block-level span5" name="country" id="country">
	        <option value="0">Select Country</option>	
	        <?php
				// $countries=mysqli_query($conn,"SELECT * FROM country ORDER BY country");
	        ...
	        <label>State</label>
	        <select class="input-block-level span5" name="region" id="region">
	        	<option value="0">Select State</option>
	        </select>
	        <label>City</label>
	        <select class="input-block-level span5" name="city" id="city">
